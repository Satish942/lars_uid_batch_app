...
public class InitailReaderHandler implements ItemReadListener<ControlFileInfo> {
	
	/**
     * Logger.
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(InitailReaderHandler.class);
