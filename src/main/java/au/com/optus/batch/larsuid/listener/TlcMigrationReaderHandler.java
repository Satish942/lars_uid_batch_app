...
public class TlcMigrationReaderHandler implements ItemReadListener<ControlFileInfo> {
	
	/**
     * Logger.
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(TlcMigrationReaderHandler.class);
